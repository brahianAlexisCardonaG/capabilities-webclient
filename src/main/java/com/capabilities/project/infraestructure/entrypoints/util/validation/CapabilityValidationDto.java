...
public class CapabilityValidationDto {
    ...
    public Mono<Void> validateFieldNotNullOrBlank(CapabilityDto dto) {
    ...
    public Mono<Void> validateLengthWords(CapabilityDto dto) {
    ...
    public Mono<Void> validateNoDuplicateNames(List<CapabilityDto> dtoList) {
